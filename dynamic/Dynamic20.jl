...
fOut=open("Dynamic20"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Dynamic20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("DynamicD20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
