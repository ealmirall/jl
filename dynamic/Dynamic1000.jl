...
fOut=open("Dynamic1000"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Dynamic1000"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("DynamicD1000"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
