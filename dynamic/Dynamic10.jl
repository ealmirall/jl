...
fOut=open("Dynamic10"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Dynamic10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("DynamicD10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
