...
fOut=open("Static20"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Static20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("StaticD20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
