...
fOut=open("Static200"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Static200"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("StaticD200"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
