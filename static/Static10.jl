...
fOut=open("Static10"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Static10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("StaticD10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
