...
fOut=open("rStatic1000"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rStatic1000"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rStaticD1000"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
