...
fOut=open("rStatic10"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rStatic10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rStaticD10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
