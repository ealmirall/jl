...
fOut=open("rStatic200"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rStatic200"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rStaticD200"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
