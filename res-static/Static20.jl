...
fOut=open("rStatic20"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rStatic20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rStaticD20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
