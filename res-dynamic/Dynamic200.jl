...
fOut=open("rDynamic200"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rDynamic200"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rDynamicD200"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
