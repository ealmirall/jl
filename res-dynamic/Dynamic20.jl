...
fOut=open("rDynamic20"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rDynamic20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rDynamicD20"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
