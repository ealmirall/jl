...
fOut=open("rDynamic10"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rDynamic10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rDynamicD10"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
