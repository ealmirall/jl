...
fOut=open("rDynamic1000"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("rDynamic1000"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("rDynamicD1000"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
