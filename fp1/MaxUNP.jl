...
fOut=open("MaxP-UNP"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("MaxP-UNP"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("MaxPD-UNP"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
