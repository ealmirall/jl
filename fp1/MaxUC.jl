...
nBestCases=10
maxPivots=1000000	#this is a mean
...
fOut=open("MaxP-UC"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("MaxP-UC"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("MaxPD-UC"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
