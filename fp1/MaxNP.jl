...
fOut=open("MaxP-NP"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("MaxP-NP"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("MaxPD-NP"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
