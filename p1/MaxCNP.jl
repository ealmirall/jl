...
fOut=open("MaxP-CNP"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("MaxP-CNP"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("MaxPD-CNP"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
