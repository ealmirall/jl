...
fOut=open("Dynamic10-f"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Dynamic10-f"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("DynamicD10-f"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
