...
fOut=open("Dynamic200-f"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Dynamic200-f"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("DynamicD200-f"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
