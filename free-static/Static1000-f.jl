...
fOut=open("Static1000-f"strftime("%Y-%m-%d %H:%S", ftime)".dat","w+")
fOutCsv=open("Static1000-f"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
fOutCsvD=open("StaticD1000-f"strftime("%Y-%m-%d %H:%S", ftime)".csv","w+")
